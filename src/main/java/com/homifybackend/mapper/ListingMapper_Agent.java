...
//NDuy
public class ListingMapper_Agent {
    ...
    public static SaleListing applyToSale(SaleListing target, ListingRequest req) {
        ...
        if (req.getMedia() != null && req.getMedia().getImages() != null) {
            ...
            for (ListingImageDTO dto : req.getMedia().getImages()) {
                ...
                img.setUrl(dto.url());
                img.setIsPrimary(dto.isPrimary());
    ...
    public static ListingResponse_Duy toResponseFromSale(SaleListing x) {
        ListingResponse_Duy r = new ListingResponse_Duy();
        r.setId(x.getId());
    ...
    public static ListingResponse_Duy toResponseFromRent(RentalListing x) {
        ListingResponse_Duy r = new ListingResponse_Duy();
        r.setId(x.getId());
